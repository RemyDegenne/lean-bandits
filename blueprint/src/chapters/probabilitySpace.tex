...
For any $t \in \mathbb{N}$, the conditional distribution of $X_{t+1}$ given the history $H_t$ as a function $\prod_{s=0}^t \Omega_s \to \Omega_{t+1}$ is $(\pi_{[1,t+1]*} P_{\mathcal{T}})$-almost surely equal to $\kappa_t$.
\end{lemma}
