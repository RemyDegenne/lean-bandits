...
\begin{definition}[Explore-Then-Commit algorithm]\label{def:etcAlgorithm}
  \leanok
  \lean{Bandits.etcNextArm, Bandits.etcAlgorithm}
...
\begin{proof}
  \uses{lem:hasLaw_rewardByCount, lem:iIndepFun_rewardByCount, lem:independent_rewardByCount, lem:sum_rewardByCount, thm:hoeffding}
\begin{align*}
  \mathbb{P}(\hat{A}_m^* = a)
